...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        List<UserMealWithExceed> filteredMealsWithExceeded = getFilteredMealsWithExceeded(getMeals(), LocalTime.of(7, 0),
                LocalTime.of(12, 0), 2000);
        filteredMealsWithExceeded.forEach(System.out::println);

        System.out.println(getFilteredMealsWithExceededByCycle(getMeals(), LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
    ...
    public static List<UserMealWithExceed> getFilteredMealsWithExceededByCycle(List<UserMeal> mealList,
        ...
        mealList.forEach(meal -> caloriesSumPerDate.merge(meal.getDateTime().toLocalDate(), meal.getCalories(),
                Integer::sum));
